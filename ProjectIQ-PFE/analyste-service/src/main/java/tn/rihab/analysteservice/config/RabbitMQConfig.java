...
public class RabbitMQConfig {
    ...
    public static final String Q_DOSSIER_P1_EXTRACTED = "q.analyste.dossier.p1.extracted";
    ...
    public static final String Q_IA_AUDIT_LOG = "q.analyste.ia.audit";

    @Bean
    public Queue qIaAuditLog() { return QueueBuilder.durable(Q_IA_AUDIT_LOG).build(); }

    @Bean
    public Binding bindingIaAuditLog() {
        return BindingBuilder.bind(qIaAuditLog()).to(dossierExchange()).with(RK_IA_AUDIT_LOG);
    }

    @Bean
    public Queue qDossierP1Extracted() { return QueueBuilder.durable(Q_DOSSIER_P1_EXTRACTED).build(); }
    ...
    public Binding bindingDossierP1Extracted() {
        return BindingBuilder.bind(qDossierP1Extracted()).to(dossierExchange()).with(RK_DOSSIER_P1_EXTRACTED);
    }
