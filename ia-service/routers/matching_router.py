...
def generate_matrix(matching_result: dict) -> dict:
    ...
    """
    dossier_id = matching_result.get("dossier_id", "")
    if not dossier_id:
    ...
    try:
        ...
        matrice = diff_matrix_service.generate_diff_matrix(matching_result, dossier_id, custom_prompts)
        return {"dossier_id": dossier_id, "matrice": matrice}
    except (ValueError, RuntimeError) as e:
